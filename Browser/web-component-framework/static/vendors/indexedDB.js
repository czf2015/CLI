export function open(dbName, version) {
...
export function create(db, tableName, primaryKey, entries) {
...
export function add(db, tableName, entry) {
    return new Promise((resolve, reject) => {
...
export function read(db, tableName, primaryKey) {
    return new Promise((resolve, reject) => {
...
export function readAll(db, tableName) {
    return new Promise((resolve, reject) => {
...
export function update(db, tableName, entry) {
    return new Promise((resolve, reject) => {
...
export function remove(db, tableName, primaryKey) {
    return new Promise((resolve, reject) => {
        const request = db.transaction([tableName], 'readwrite')
            .objectStore(tableName)
            .delete(primaryKey);
